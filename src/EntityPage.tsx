...
export default function EntityPage() {
    ...
    return (
      <div className="v2-page entity-page">
        ...
        <section className="entity-empty">
          ...
          <NavLink to="/descobertas">← Voltar para Descobertas</NavLink>
        </section>
      </div>
    )
  }
  ...
  return (
    <div className="v2-page entity-page">
      <BrandTop />
      <NavLink className="back-v2" to="/descobertas">← Descobertas</NavLink>
      ...
      <section className="entity-records">
        ...
        <div className="memory-list">
          {entity.records.map((record) => (
            <article key={record.id} className="entity-record-card">
