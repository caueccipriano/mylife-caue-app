...
export const areas: Area[] = [
  {
    ...
    now: 'Consolidando experiência em custos, controladoria e análise.',
    direction: 'Evoluir profissionalmente sem perder a abertura para dados.',
    active: ['Evolução profissional', 'Portfólio de dados'],
    decisions: 8,
  },
  {
    id: 'dinheiro',
...
export const projects: Project[] = [
  ...
  },
  {
    ...
    phase: 'Construção',
    summary: 'Transformar experiência atual em próximos passos de carreira mais claros.',
    context: 'O projeto reúne formação, currículo, portfólio e escolhas de carreira que antes ficavam espalhadas.',
    decisions: ['Manter custos/controladoria como base', 'Desenvolver competência em dados'],
    next: ['Consolidar portfólio', 'Registrar marcos profissionais'],
  },
  {
    id: 'eu',
    name: 'EU',
